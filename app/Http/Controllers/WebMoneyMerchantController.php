...
use ActionM\WebMoneyMerchant\Facades\WebMoneyMerchant;
use ActionM\WebMoneyMerchant\Test\Dummy\Order;
use Illuminate\Http\Request;


class WebMoneyMerchantController extends Controller
{
    /**
    ...
    public function searchOrderFilter(Request $request,$order_id)
    {
